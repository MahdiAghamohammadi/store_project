...
class FAQController extends Controller
{
    ...
    public function store(FaqRequest $request)
    {
        ...
        return redirect(route('admin.content.faq.index'))->with('swal-success', 'سوال مورد نظر با موفقیت اضافه شد.');
    }
    ...
    public function update(FaqRequest $request, Faq $faq)
    {
        $inputs = $request->all();
        $faq->update($inputs);
        return redirect(route('admin.content.faq.index'))->with('swal-success', 'سوال مورد نظر با موفقیت ویرایش شد.');
    }
