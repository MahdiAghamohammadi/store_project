...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        ...
        return redirect(route('admin.content.menu.index'))->with('swal-success', 'منو مورد نظر با موفقیت اضافه شد.');
    }
    ...
    public function update(MenuRequest $request, Menu $menu)
    {
        $inputs = $request->all();
        $menu->update($inputs);
        return redirect(route('admin.content.menu.index'))->with('swal-success', 'منو مورد نظر با موفقیت ویرایش شد.');
    }
    ...
    {
        $result = $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منو مورد نظر با موفقیت حذف شد.');
    }
