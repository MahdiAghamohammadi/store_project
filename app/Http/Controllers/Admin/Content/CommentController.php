...
class CommentController extends Controller
{
    ...
    public function answer(CommentRequest $request, Comment $comment)
    {
        if ($comment->parent == null) {
            ...
            return redirect(route('admin.content.comment.index'))->with('swal-success', 'پاسخ مورد نظر با موفقیت اضافه شد.');
        } else {
            return redirect(route('admin.content.comment.index'))->with('swal-error', 'خطا! نمیتوانید برای پاسخ ادمین پاسخی در نظر بگیرید.');
        }
    }
}
