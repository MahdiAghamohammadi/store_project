...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
        ...
        return redirect(route('admin.content.page.index'))->with('swal-success', 'صفحه مورد نظر با موفقیت اضافه شد.');
    }
    ...
    {
        $result = $page->delete();
        return redirect()->route('admin.content.page.index')->with('swal-success', 'صفحه نظر با موفقیت حذف شد.');
    }
