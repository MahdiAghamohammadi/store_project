...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request, ImageService $imageService)
    {
        ...
        if ($result === false) {
            return redirect()->route('admin.market.product.index')->with('swal-success', 'آپلود عکس با خطا مواجه شد.');
        }
        $inputs['image'] = $result;
        ...
        return redirect(route('admin.market.product.index'))->with('swal-success', 'کالا مورد نظر با موفقیت اضافه شد.');
    }
    ...
    public function update(ProductRequest $request, Product $product, ImageService $imageService)
    {
        ...
        return redirect(route('admin.market.product.index'))->with('swal-success', 'کالا مورد نظر با موفقیت ویرایش شد.');
    }
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.market.product.index')->with('swal-success', 'برند مورد نظر با موفقیت حذف شد.');
    }
}
