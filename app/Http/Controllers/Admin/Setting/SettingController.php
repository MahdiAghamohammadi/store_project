...
class SettingController extends Controller
{
    ...
    public function update(SettingRequest $request, Setting $setting, ImageService $imageService)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            if ($result === false) {
                return redirect()->route('admin.setting.index')->with('swal-success', 'آپلود عکس با خطا مواجه شد.');
            }
            $inputs['logo'] = $result;
        }
        ...
        return redirect(route('admin.setting.index'))->with('swal-success', 'تنظیمات مورد نظر با موفقیت ویرایش شد.');
    }
