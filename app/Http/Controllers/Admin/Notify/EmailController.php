...
class EmailController extends Controller
{
    ...
    public function store(EmailRequest $request)
    {
        ...
        return redirect(route('admin.notify.email.index'))->with('swal-success', 'اعلامیه ایمیلی مورد نظر با موفقیت اضافه شد.');
    }
    ...
    public function update(EmailRequest $request, Email $email)
    {
        ...
        $inputs['published_at'] = date("Y-m-d H:i:s", (int) $realTimestampStart);
        $email->update($inputs);
        return redirect(route('admin.notify.email.index'))->with('swal-success', 'اعلامیه ایمیلی مورد نظر با موفقیت ویرایش شد.');
    }
    ...
    {
        $email->delete();
        return redirect(route('admin.notify.email.index'))->with('swal-success', 'اعلامیه ایمیلی مورد نظر با موفقیت حذف شد.');
    }
    ...
    public function sendMail(Email $email)
    {
        ...
        return back()->with('swal-success', 'اعلامیه ایمیلی مورد نظر با موفقیت ارسال شد.');
    }
}
