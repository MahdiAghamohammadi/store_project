...
class TicketController extends Controller
{
    ...
    public function change(Ticket $ticket)
    {
        ...
        $result = $ticket->save();
        return redirect()->route('admin.ticket.index')->with('swal-success', 'وضعیت تیکت مورد نظر تغییر کرد');
    }
    ...
    public function answer(TicketRequest $request, Ticket $ticket)
    {
        ...
        return redirect(route('admin.ticket.index'))->with('swal-success', 'پاسخ مورد نظر با موفقیت ثبت شد.');
    }
}
