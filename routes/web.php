...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('order')->group(function () {
            ...
            Route::get('/canceled', [OrderController::class, 'cancel'])->name('admin.market.order.cancel');
        ...
        Route::prefix('payment')->group(function () {
            ...
            Route::get('/not-paid/{payment}', [PaymentController::class, 'notPaid'])->name('admin.market.payment.not-paid');
...
Route::namespace('SalesProcess')->group(function () {
    ...
    // profile
    Route::get('/profile_completion', [ProfileCompletionController::class, 'profileCompletion'])->name('customer.sales-process.profile_completion');
    Route::post('/profile_completion', [ProfileCompletionController::class, 'update'])->name('customer.sales-process.profile-completion-update');
...
// get products api example
Route::get('/api-products', [CustomerProductController::class, 'viewProductsApi']);
