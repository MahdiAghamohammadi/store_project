                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9 mb-3">
                            <form action="" id="cart-items" method="post"
                                    ...
                                    <section class="cart-item d-md-flex py-3">
                                        ...
                                        <section class="align-self-start w-100">
                                            ...
                                            <p>
                                                ...
                                                @else
                                                    <span>گارانتی منتخب وجود ندارد</span>
                                                @endif
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-danger fw-bolder" id="total_discount">
                                        {{ priceFormat($totalDiscount) }} تومان</p>
                                </section>
                                ...
                                <section class="">
                                    <button onclick="document.getElementById('cart-items').submit();"
                                        class="btn btn-danger btn-block w-100 d-block">تکمیل فرآیند خرید</button>
                                </section>
