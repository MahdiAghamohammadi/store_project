                ...
                <section class="address-select">
                    ...
                    @forelse (auth()->user()->addresses as $address)
                        <section class="my-address-wrapper mb-2 p-2">
                            ...
                            <a class="" data-bs-toggle="modal" data-bs-target="#edit-address-{{ $address->id }}"
                                href=""><i class="fa fa-edit"></i> ویرایش آدرس</a>
                        </section>
                            ...
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    <section class="modal-header">
                                        <h5 class="modal-title" id="add-address-label"><i class="fa fa-plus"></i>ویرایش
                                            آدرس</h5>
                                        ...
                                        <form class="row" method="POST"
                                            ...
                                            <section class="col-6 mb-2">
                                                ...
                                                <input name="postal_code" type="text"
                                                    ...
                                                    placeholder="کد پستی" value="{{ $address->postal_code }}">
                                            </section>
                                            ...
                                            <section class="col-12 mb-2">
                                                <section class="form-check">
                                                    <input {{ $address->recipient_first_name ? 'checked' : '' }}
                                                        name="receiver" class="form-check-input" type="checkbox"
                                                        id="receiver">
                    ...
                    <section class="address-add-wrapper">
                        ...
                        <section class="modal fade" id="add-address" tabindex="-1" aria-labelledby="add-address-label"
                            ...
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    <section class="modal-header">
                                        <h5 class="modal-title" id="add-address-label"><i class="fa fa-plus"></i> ایجاد
                                            آدرس جدید</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </section>
