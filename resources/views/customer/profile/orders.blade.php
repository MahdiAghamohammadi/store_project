        ...
        <main id="main-body" class="main-body col-md-9">
            <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                ...
                <section class="d-flex justify-content-center my-4">
                    ...
                    <a class="btn btn-info btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=0') }}">برسی
                        نشده</a>
                    <a class="btn btn-warning btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=1') }}">در انتظار
                        تایید</a>
                    <a class="btn btn-danger btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=2') }}">تایید
                        نشده</a>
                    <a class="btn btn-success btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=3') }}">تایید
                        شده</a>
                                ...
                                <section>
                                    ...
                                    <section class="order-item-products">
                                        @foreach ($order->orderItems as $item)
                                            <a href="#">
                                                <img src="{{ asset(json_decode($item->product)->image->indexArray->small) }}"
                                                    alt="">
                                            </a>
                                        @endforeach
                                    </section>
