    ...
    <section class="row">
        ...
        <main id="main-body" class="main-body col-md-9">
            ...
            <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                ...
                <section class="modal fade" id="edit-profile" tabindex="-2" aria-labelledby="edit-profile-label"
                    aria-hidden="true">
                    <section class="modal-dialog">
                        <section class="modal-content">
                            ...
                            <section class="modal-body">
                                <form class="row" method="POST" action="{{ route('customer.profile.profile.update') }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <section class="col-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="national_code"
                                                id="national_code" value="{{ $user->national_code ?? '-' }}">
                                        </div>
                                    </section>
