    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form
                        action="{{ route('admin.market.value.update', ['attribute' => $attribute->id, 'value' => $value->id]) }}"
                        method="POST">
                        @csrf
                       @method('put')
                        <section class="row">
                            ...
                            <section class="my-2 col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price_increase" id="price_increase"
                                        class="form-control form-control-sm" value="{{ old('price_increase', json_decode($value->value)->price_increase) }}">
                                </div>
